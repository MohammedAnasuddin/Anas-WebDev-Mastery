...
export const DishCard = (props)=>{
    ...
    return (
        <div data-testid="Dcard" style={{width:"max-content", height:"max-content",border:"2px solid darkgray", borderRadius:"8px", backgroundColor:"#f5f3f3f8",margin:"4px",padding:"4px 8px", lineHeight:"2px"}}>
